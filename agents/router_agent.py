...
def route_and_respond(user_message: str, intent: str = None):
    ...
    if intent == "explain":
        return intent, explain_concept_chat(user_message)
    elif intent == "code":
        return intent, generate_code_chat(user_message)
    elif intent == "test":
        return intent, generate_problem_chat(user_message)
    else:
        return intent, general_chat(user_message)
